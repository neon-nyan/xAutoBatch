...
:DoUpdate
    ...
    %wgetPath% --no-check-certificate -L -q https://github.com/neon-nyan/xAutoBatch/archive/v!newmajver!.!newminver!.!newrevver!.zip -O "%downtempdir%\%progname%-!newmajver!.!newminver!.!newrevver!.zip" | echo Mendapatkan paket...
